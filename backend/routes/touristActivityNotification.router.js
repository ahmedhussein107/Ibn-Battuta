...
touristActivityNotificationRouter.post('/createTouristActivityNotification',async (req, res) => {
...
touristActivityNotificationRouter.get('/allTouristActivityNotifications', async (req, res) => {
...
touristActivityNotificationRouter.delete('/deleteAllTouristActivityNotifications', async (req, res) =>{
    try{
        await TouristActivityNotification.deleteMany();
        res.status(200).json({message:'All touristActivity notifications deleted'});
    }catch(e){
        res.status(500).json({message:e.message});
    }
});
