...
const notificationSchema = new mongoose.Schema(
	{
		...
		relatedType: {
			type: String,
			enum: ["Complaint", "Activity", "Itinerary", "Product", "PromoCode"],
			required: true,
		},
		relatedId: { type: mongoose.Schema.Types.Mixed, refPath: "relatedType" },
	},
	{
		timestamps: true,
	}
...
const validateRelatedTypeAndId = async (relatedType, relatedId, next) => {
	try {
		const validModels = ["Complaint", "Activity", "Itinerary", "Product", "PromoCode"];
